...
The list of fields available to create Daemonset:
...
The list of fields available to create the Daemonset:
- JsonData: Required field

### List

The list of fields available to list daemonset in particular namespace:
- Namespace: Required field
- Label: Optional field

The list of fields available to list daemonset in all namespace:
- Label: Optional field

### Get

The list of fields available to get daemonset in particular namespace:
- Namespace: Required field
- Name: Required field

### Delete

The list of fieds available to delete daemonset in particular namespace:
- Namespace: Required field
- Name: Required field

### Update

The list of fields available to update daemonset in particular namespace(We can update label, annotation, replica or image):
- Namespace: Required field
- Name: Required field
- Label: Optional field
